...
# def save_new_vs_old_record(i, savedir, nwins, pwins, draws, naccepted):
...
#     one_record = pd.DataFrame([[i-1,i,nwins,pwins,draws, naccepted]],columns=['prev','new','nwins','pwins','draws','naccepted'])
...
class Coach():
    ...
    def learn(self):
        ...
        for i in range(1, self.args.numIters + 1):
            ...
            # record_df = save_new_vs_old_record(i, self.args.checkpoint, nwins, pwins, draws, naccepted)
