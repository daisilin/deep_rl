...
# DATABASE_LOC = '/scratch/xl1005/deep-master/tournaments/subset_players_for_moves.pkl'
# DATABASE_LOC_backup = '/scratch/xl1005/deep-master/tournaments/subset_players_for_moves_backup.pkl'
...
# TOURNAMENT_RES_LOC = '/scratch/xl1005/deep-master/tournaments/subset_players_for_moves_round_robin_base.pkl'
# TOURNAMENT_RES_LOC = tn.TOURNAMENT_BASE_LOC
# TOURNAMENT_RES_LOC_backup = '/scratch/xl1005/deep-master/tournaments/asubset_players_for_moves_robin_base_backup.pkl'
...
# REPEATED_TOURNAMENT_RES_LOC ='/scratch/xl1005/deep-master/tournaments/subset_player_repeated_round_robin_for_moves.pkl'
...
# REPEATED_TOURNAMENT_RES_LOC_backup = '/scratch/xl1005/deep-master/tournaments/subset_player_repeated_round_robin_base_for_moves_backup.pkl'
...
def extend_database(backup=True):
    ...
    tournament_to_update_pair = [('tournament_17',{'color':True,'continuous_training':True,'tempThreshold':15,'dir_alpha':0.3}),
                             ('tournament_18',{'color':True,'continuous_training':True,'tempThreshold':15,'dir_alpha':0.3}),
                             ('tournament_19',{'color':True,'continuous_training':True,'tempThreshold':15,'dir_alpha':0.3}),
                             # ('tournament_19',{'color':True,'continuous_training':True,'tempThreshold':15,'dir_alpha':0.3}),
                             # ('tournament_19',{'color':True,'continuous_training':True,'tempThreshold':15,'dir_alpha':0.3}),
                             # ('tournament_19',{'color':True,'continuous_training':True,'tempThreshold':15,'dir_alpha':0.3})
                            ]
