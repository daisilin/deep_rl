...
root_dir = '../final_agents'
DATABASE_LOC = '../final_agents/all_players.pkl'
DATABASE_LOC_backup = '../final_agents/all_players_backup.pkl'

TOURNAMENT_RES_LOC = '../final_agents/ai_all_player_round_robin_base.pkl'
# TOURNAMENT_RES_LOC = tn.TOURNAMENT_BASE_LOC
TOURNAMENT_RES_LOC_backup = '../final_agents/ai_all_player_round_robin_base_backup.pkl'
# TOURNAMENT_RES_LOC_backup = tn.TOURNAMENT_BASE_backup_LOC

REPEATED_TOURNAMENT_RES_LOC = '../final_agents/ai_all_player_repeated_round_robin_base.pkl'
REPEATED_TOURNAMENT_RES_LOC_backup = '../final_agents/ai_all_player_repeated_round_robin_base_backup.pkl'
