...
class MCTS():
    ...
    def search(self, canonicalBoard):
        ...
        if s not in self.Ps:
            ...
            self.Ps[s], v = self.nnet.predict.remote(canonicalBoard) # (boardsize,) scalar
...
if __name__ == '__main__':
    ...
    mcts = MCTS.remote(game,nn,MCTS_ARGS)
