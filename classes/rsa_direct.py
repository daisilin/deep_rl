...
# path_activity = f'/scratch/xl1005/deep-master/rsa/{model_line}/activity_layer'
...
def get_rsa_results():
    ...
    names = ['v','p','flattenp','flattenv','relu5','relu3','relu1','convp','convv','dense1','input']
    feature_num = '3'
    path_activity = f'/scratch/xl1005/deep-master/rsa/{model_line}/results/{feature_name}_extra/seed3/fixed'
